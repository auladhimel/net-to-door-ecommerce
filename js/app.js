...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    // single product 
    div.innerHTML = `<div style="height: 540px;" class="single-product">
      <div style="margin-top:20px">
    <img class="product-image" src=${image}></img>
      </div>
      <h3>${product.title}</h3>
      <p>Category: ${product.category}</p>
      <h3 style="font-weight:bold;">Price: $ ${product.price}</h3>
      <p style="color:#76323F; font-weight:bold;">Rating: ${product.rating.rate} out of 5 </p>
      <p> <span style="font-weight:bold">${product.rating.count}</span> Customer Reviews </p>
...
const updateTaxAndCharge = () => {
  ...
  // update delivery charge and tax for more than 200 
  if (priceConverted > 200) {
    setInnerText("delivery-charge", 30);
    setInnerText("total-tax", priceConverted * 0.2);
  }
  // update delivery charge and tax for more than 400 
  if (priceConverted > 400) {
    setInnerText("delivery-charge", 50);
    setInnerText("total-tax", priceConverted * 0.3);
  }
  // update delivery charge and tax for more than 500
